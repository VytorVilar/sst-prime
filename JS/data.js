/* ==================================================
JS/data.js
VERSÃO ENXUTA (ESTILO QUE VOCÊ QUER)
SÓ COLAR NO LUGAR DO epis:[]
================================================== */
...
const DATA = {
  ...
  { categoria: "🥾 Calçados", nome: "Botina de Elástico com Bico de PVC - Fujiwara", ca: "48.413", imagem: "https://http2.mlstatic.com/D_NQ_NP_2X_640854-MLB89733674143_082025-F-botina-bota-de-seguranca-usafe-fujiwara-bico-pvc.webp" },
  { categoria: "🥾 Calçados", nome: "Bota de Segurança ComBico de PVC ModeloLeve e Muito Conforto", ca: "45.258", imagem: "https://http2.mlstatic.com/D_NQ_NP_2X_690923-MLB105362150795_012026-F-bota-seguranca-de-couro-com-ca-bico-pvc-conforto-no-trabalho.webp" },
  ...
  { categoria: "🦾 Mangotes", nome: "Mangote de Raspa Soldador com Elásticos 40cm - Zanel", ca: "16.073", imagem: "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQiboRItuNH3WRmJqZCFXgyMeFb9ZXzJeZgrdx_Li30JMdCOepXKbj84XQO69Ie4_FibWsTUxEoYkWI8x-I9Dl1pzFKlALBSNBSKw8QbCx32CZ0w9U6Ytfx2UIBHA&usqp=CAc" },
  { categoria: "🦺 Aventais", nome: "Avental de Raspa 120x60cm sem Emendas - Zanel", ca: "13.989", imagem: "https://http2.mlstatic.com/D_NQ_NP_2X_883677-MLB31757432415_082019-F-10-un-avental-de-raspa-couro-soldador-s-emenda-120x060-epi.webp" },
  { categoria: "🦺 Aventais", nome: "Avental de PVC Branco - Maicol", ca: "37.729", imagem: "https://images.tcdn.com.br/img/img_prod/1145511/avental_pvc_maicol_branco_1_20x0_60_ca_37729_685_1_f228876937efd1395a38329a3ad49eef.jpg" },
  ...
  { categoria: "😷 Máscaras", nome: "Máscara PFF1 com ProSafety - Delta Plus", ca: "38.501", imagem: "https://www.astrodistribuidora.com/media/catalog/product/cache/1/image/600x/9df78eab33525d08d6e5fb8d27136e95/r/e/respirador_pff1_com_v_lvula.jpeg" },
  { categoria: "😷 Máscaras", nome: "Máscara N95 PF2 - Nutriex Safety", ca: "46.868", imagem: "https://http2.mlstatic.com/D_NQ_NP_697910-MLU70618800016_072023-O.webp" },
  { categoria: "😷 Máscaras", nome: "Máscara PFF2 - Delta Plus", ca: "38.503", imagem: "https://www.astrodistribuidora.com/media/catalog/product/cache/1/image/600x/9df78eab33525d08d6e5fb8d27136e95/r/e/respirador_pff2_com_v_lvula.jpeg" },
  ...
  { categoria: "📌 Epis", nome: "Mascara De Solda", ca: "14.199", imagem:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpxGO5zYA_C4G3PiMpmRrci4FUG6ujoM8yAg&s" },
  ...
  { categoria: "🧥 Vestuário Térmico", nome: "Bota Térmica", ca: "42.632", imagem: "https://safetytrab.com.br/wp-content/uploads/2018/04/Meia-T%C3%A9rmica-Botinha-Maicol.jpg" },
...
empresas:[
  ...
  { emoji:"🔊", risco:"RUÍDO", nome:"FAP INDÚSTRIA E COMÉRCIO DE ACRÍLICOS LTDA", setor:"Dobra" },
  { emoji:"🌫", risco:"POEIRA", nome:"FAP INDÚSTRIA E COMÉRCIO DE ACRÍLICOS LTDA", setor:"Polimento" },
  { emoji:"🛠", risco:"FERRAMENTAS MANUAIS/MÁQUINAS E EQUIPAMENTOS", nome:"FAP INDÚSTRIA E COMÉRCIO DE ACRÍLICOS LTDA", setor:"Produção" },
  { emoji:"🧼", risco:"PRODUTOS DOMISSANITÁRIOS DE LIMPEZA", nome:"FAP INDÚSTRIA E COMÉRCIO DE ACRÍLICOS LTDA", setor:"Limpeza" },
  { emoji:"👷‍♂️", risco:"TRABALHO EM ALTURA", nome:"JF CONSTRUCAO E PAVIMENTAÇÃO LTDA", setor:"Obra" },
  { emoji:"🧺", risco:"TINTAS/DILUENTES", nome:"PREST-MAC COMERCIAL E INDUSTRIAL LTDA", setor:"Pintura" },
  { emoji:"⚡", risco:"TRABALHO COM ELETRICIDADE", nome:"WGL SOLUÇÕES EM TECNOLOGIAS E SERVIÇOS LTDA", setor:"Manutenção/Elétrica (Preventiva/Corretiva)" },
  { emoji:"🧴", risco:"LUBRIFICANTES", nome:"PREST-MAC COMERCIAL E INDUSTRIAL LTDA", setor:"Produção" },
  { emoji:"✨", risco:"PRODUTOS QUÍMICOS DE ESTÉTICA", nome:"ELENICE GERALDO DOS SANTOS CABELEIREIROS LTDA", setor:"Salão" },
  { emoji:"🍔", risco:"MANIPULAÇÃO DE ALIMENTOS", nome:"PÃES E DOCES CHALÉ DOCILE LTDA", setor:"Cozinha" },
  { emoji:"🚗", risco:"CONDUÇÃO DE VEÍCULOS AUTOMOTORES", nome:"POLICOMP COMERCIO DE COMPONENTES", setor:"Estoque/Transporte" },
  { emoji:"🔩", risco:"FUMOS METÁLICOS DE ESTANHO", nome:"POLICOMP COMERCIO DE COMPONENTES", setor:"Técnico" },
  { emoji:"💥", risco:"RADIAÇÃO NÃO IONIZANTE", nome:"SPADA MIDIA E EVENTOS LTDA", setor:"Obra/Serralheria" },
  { emoji:"😸🐶", risco:"PRODUTOS QUÍMICOS DE BELEZA PARA CÃES E GATOS", nome:"CAROL PET SHOP COMERCIO DE RACOES ACESSORIOS BANHO E TOSA LTDA", setor:"Banho e Tosa" },
  { emoji:"📦", risco:"TRABALHOS DE SEPARAÇÃO DE EMBALAGENS", nome:"MONTE VIRGINNE COMÉRCIO DE SUCATAS DE PLÁSTICOS LTDA ME", setor:"Produção/Separação" },
  { emoji:"❄", risco:"FRIO", nome:"LANCHONETE E ESFIHARIA NOVA ALIANCA LTDA", setor:"Cozinha" },
  { emoji:"🧴", risco:"ÓLEO SINTÉTICO", nome:"DELTA ROTULADORAS EIRELI", setor:"Fábrica" },
  { emoji:"🗜", risco:"ESTANHO", nome:"RAUL SANTOS FERREIRA", setor:"Produção" },
  { emoji:"🩹", risco:"ACIDENTES", nome:"RIO BONITO COMERCIO E SERVICOS PARA PISCINAS LTDA", setor:"Assistencia" },
  { emoji:"⚕️", risco:"VIRUS E BACTÉRIAS", nome:"RIO BONITO COMERCIO E SERVICOS PARA PISCINAS LTDA", setor:"Externo" },
  { emoji:"💦", risco:"CLORO", nome:"RIO BONITO COMERCIO E SERVICOS PARA PISCINAS LTDA", setor:"Externo" },
  
],

w2h: [

    { titulo:"What (O Quê)", texto:"Treinamento de NR-06" },
    { titulo:"Who (Quem)", texto:"Coordenador da empresa" },
    { titulo:"When (Quando)", texto:"Permanente" },
    { titulo:"Where (Onde)", texto:"Ambiente laboral" },
    { titulo:"Why (Porquê)", texto:"Conscientizar colaboradores sobre uso de EPI." },
    { titulo:"How (Como)", texto:"Palestra NR-06, treinamento de EPI." },
    { titulo:"How much (Custo)", texto:"***" }

],
  
  
/* ==================================================
SUBSTITUA O BLOCO nrs:[] NO data.js
NRs COM LINKS
================================================== */
...

{
  codigo:"NR-05",
  nome:"CIPA",
  link:"https://www.gov.br/trabalho-e-emprego/pt-br/acesso-a-informacao/participacao-social/conselhos-e-orgaos-colegiados/comissao-tripartite-partitaria-permanente/normas-regulamentadora/normas-regulamentadoras-vigentes/norma-regulamentadora-no-5-nr-5"
},
...
{
  codigo:"NR-20",
  nome:"Instalação Classe III; Manutenção e inspeção",
...
{
  codigo:"NR-23",
  nome:"Incêndio / Brigada",
  link:"https://www.gov.br/trabalho-e-emprego/pt-br/acesso-a-informacao/participacao-social/conselhos-e-orgaos-colegiados/comissao-tripartite-partitaria-permanente/normas-regulamentadora/normas-regulamentadoras-vigentes/norma-regulamentadora-no-23-nr-23"
},
...
{
  codigo:"NR-34",
  nome:"Condições e meio ambiente na indústria naval",
  link:"https://www.gov.br/trabalho-e-emprego/pt-br/acesso-a-informacao/participacao-social/conselhos-e-orgaos-colegiados/comissao-tripartite-partitaria-permanente/normas-regulamentadora/normas-regulamentadoras-vigentes/norma-regulamentadora-no-34-nr-34"
},
...
{
  titulo:"📄 PPP",
  desc:"Modelos prontos",
  link:"https://drive.google.com/drive/folders/1TGYf5eNYzIcKbtL5x2BRb-pmc5VYGQQ-"
},

{
  titulo:"📝 Ordem de Serviço",
  desc:"Gerar documentos",
  link:"https://drive.google.com/drive/folders/1y0iZMFTM9yVcs771L3o6ldhY_YIcinC9"
},

{
  titulo:"🎓 Certificados",
  desc:"Treinamentos realizados",
  link:"https://drive.google.com/drive/folders/17GqBa56ZkdBW7OTaDcfnaaSeZQyw1u0j"
},

{
  titulo:"📝 APR",
  desc:"Análise de risco",
  link:"https://drive.google.com/drive/folders/1zqxxdwPH4VxMgX37plHRjQZUn_49XTZb"
},

{
  titulo:"📘 Provas NRs",
  desc:"Materiais de apoio",
  link:"https://drive.google.com/drive/folders/1CSdc8Az8o1G7bz6vdmfuZ5FBPEQaD6lG"
}
...
alertas: [
    ...
    "Todos sistemas operando",
    "2 empresas revisar documentos",
    "EPIs em alta demanda",
    "NR-06 mais buscada",
    "Dashboard estável"
